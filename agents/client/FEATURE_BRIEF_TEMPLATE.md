...
- 是否涉及 Protobuf / WebSocket Contract。
- 是否涉及 Web / WeChat / Douyin 平台适配。
...
- 动画、Tween、骨骼或其他持续计算。
- 是否需要对象池、懒加载、降级策略或低端机限制。

## 6. Logging / Debug
- 需要的中文日志与稳定模块标签/错误码。
- 是否需要接入 UI / Component / VFX / Network / Platform Lab 独立调试。
